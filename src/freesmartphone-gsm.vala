...
namespace FreeSmartphone {
	...
	namespace GSM {
		...
		public interface PDP : GLib.Object {
			...
			public abstract async void set_roaming_allowed(bool state) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, DBusError, IOError;

			[DBus (name = "GetRoamingAllowed")]
			public abstract async bool get_roaming_allowed() throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, DBusError, IOError;
		...
		public interface PDPSync : GLib.Object {
			...
			[DBus (name = "SetRoamingAllowed")]
			public abstract void set_roaming_allowed(bool state) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, DBusError, IOError;

			[DBus (name = "GetRoamingAllowed")]
			public abstract bool get_roaming_allowed() throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, DBusError, IOError;
		...
		public interface Call : GLib.Object {
			...
			[DBus (name = "Transfer")]
			public abstract async void transfer(string number) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, DBusError, IOError;
		...
		public interface CallSync : GLib.Object {
			...
			[DBus (name = "Transfer")]
			public abstract void transfer(string number) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, DBusError, IOError;
		...
		public interface Network : GLib.Object {
			...
			public abstract async GLib.HashTable<string, GLib.Variant> get_call_forwarding(string reason) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, DBusError, IOError;

			[DBus (name = "EnableCallForwarding")]
			public abstract async void enable_call_forwarding(string reason, string call_class, string number, int timeout) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, DBusError, IOError;

			[DBus (name = "DisableCallForwarding")]
			public abstract async void disable_call_forwarding(string reason, string call_class) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, DBusError, IOError;
		...
		public interface NetworkSync : GLib.Object {
			...
			[DBus (name = "GetCallForwarding")]
			public abstract GLib.HashTable<string, GLib.Variant> get_call_forwarding(string reason) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, DBusError, IOError;

			[DBus (name = "EnableCallForwarding")]
			public abstract void enable_call_forwarding(string reason, string call_class, string number, int timeout) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, DBusError, IOError;

			[DBus (name = "DisableCallForwarding")]
			public abstract void disable_call_forwarding(string reason, string call_class) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, DBusError, IOError;
