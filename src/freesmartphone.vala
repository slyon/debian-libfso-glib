...
namespace FreeSmartphone {
	...
	public interface Resource : GLib.Object {
		...
		public abstract async GLib.HashTable<string, GLib.Variant> get_dependencies() throws FreeSmartphone.ResourceError, FreeSmartphone.Error, DBusError, IOError;

		[DBus (name = "GetDefaultPolicy")]
		public abstract async FreeSmartphone.UsageResourcePolicy get_default_policy() throws FreeSmartphone.ResourceError, FreeSmartphone.Error, DBusError, IOError;
	}
	...
	public interface ResourceSync : GLib.Object {
		...
		[DBus (name = "GetDependencies")]
		public abstract GLib.HashTable<string, GLib.Variant> get_dependencies() throws FreeSmartphone.ResourceError, FreeSmartphone.Error, DBusError, IOError;

		[DBus (name = "GetDefaultPolicy")]
		public abstract FreeSmartphone.UsageResourcePolicy get_default_policy() throws FreeSmartphone.ResourceError, FreeSmartphone.Error, DBusError, IOError;
	}
