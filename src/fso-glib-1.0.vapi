/* fso-glib-1.0.vapi generated by valac 0.16.0, do not modify. */
...
namespace FreeSmartphone {
	...
	namespace GSM {
		...
		public interface Call : GLib.Object {
			...
			[DBus (name = "Deflect")]
			public abstract async void deflect (string number) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, GLib.DBusError, GLib.IOError;
			[DBus (name = "Emergency")]
			...
			[DBus (name = "Transfer")]
			public abstract async void transfer () throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, GLib.DBusError, GLib.IOError;
		...
		public interface CallForwarding : GLib.Object {
			[DBus (name = "Disable")]
			public abstract async void disable (string rule) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, GLib.DBusError, GLib.IOError;
			[DBus (name = "DisableAll")]
			public abstract async void disable_all (string type) throws FreeSmartphone.Error, FreeSmartphone.GSM.Error, GLib.DBusError, GLib.IOError;
			[DBus (name = "Enable")]
			public abstract async void enable (string rule, string number, int timeout) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, GLib.DBusError, GLib.IOError;
			[DBus (name = "GetStatus")]
			public abstract async GLib.HashTable<string,GLib.Variant> get_status (string rule) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, GLib.DBusError, GLib.IOError;
		...
		public interface CallForwardingSync : GLib.Object {
			[DBus (name = "Disable")]
			public abstract void disable (string rule) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, GLib.DBusError, GLib.IOError;
			[DBus (name = "DisableAll")]
			public abstract void disable_all (string type) throws FreeSmartphone.Error, FreeSmartphone.GSM.Error, GLib.DBusError, GLib.IOError;
			[DBus (name = "Enable")]
			public abstract void enable (string rule, string number, int timeout) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, GLib.DBusError, GLib.IOError;
			[DBus (name = "GetStatus")]
			public abstract GLib.HashTable<string,GLib.Variant> get_status (string rule) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, GLib.DBusError, GLib.IOError;
			[DBus (name = "StatusChanged")]
			public signal void status_changed (string rule, GLib.HashTable<string,GLib.Variant> status);
		}
		[CCode (cheader_filename = "freesmartphone.h")]
		...
		public interface CallSync : GLib.Object {
			...
			[DBus (name = "Deflect")]
			public abstract void deflect (string number) throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, GLib.DBusError, GLib.IOError;
			[DBus (name = "Emergency")]
			...
			[DBus (name = "Transfer")]
			public abstract void transfer () throws FreeSmartphone.GSM.Error, FreeSmartphone.Error, GLib.DBusError, GLib.IOError;
			[DBus (name = "CallStatus")]
			public signal void call_status (int id, FreeSmartphone.GSM.CallStatus status, GLib.HashTable<string,GLib.Variant> properties);
		}
		[CCode (cheader_filename = "freesmartphone.h")]
	...
	public interface Resource : GLib.Object {
		...
		[DBus (name = "GetDefaultPolicy")]
		public abstract async FreeSmartphone.UsageResourcePolicy get_default_policy () throws FreeSmartphone.ResourceError, FreeSmartphone.Error, GLib.DBusError, GLib.IOError;
		[DBus (name = "GetDependencies")]
		public abstract async GLib.HashTable<string,GLib.Variant> get_dependencies () throws FreeSmartphone.ResourceError, FreeSmartphone.Error, GLib.DBusError, GLib.IOError;
		[DBus (name = "Resume")]
	...
	public interface ResourceSync : GLib.Object {
		...
		[DBus (name = "GetDefaultPolicy")]
		public abstract FreeSmartphone.UsageResourcePolicy get_default_policy () throws FreeSmartphone.ResourceError, FreeSmartphone.Error, GLib.DBusError, GLib.IOError;
		[DBus (name = "GetDependencies")]
		public abstract GLib.HashTable<string,GLib.Variant> get_dependencies () throws FreeSmartphone.ResourceError, FreeSmartphone.Error, GLib.DBusError, GLib.IOError;
		[DBus (name = "Resume")]
